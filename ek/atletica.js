...
loadScript('https://your-gpt.github.io/widget/config.js', () => {
    loadScript(config.injectUrl, () => {
        window.botpress.init({
            "botId": "194ed695-d1f6-4930-bbfc-5d7c5bc5d71a",
            "clientId": "feefd7d2-b5ce-4737-a9e0-fea32467b9d8",
            "configuration": {
  ...
  chatbotButton.innerHTML = `
      <img src="https://jiqndffacllyrwbercfc.supabase.co/storage/v1/object/public/products/caecf5bb-67ca-4c1c-8466-2d8a01200bf3/1739368665664.gif" style="width: 60px; height: 60px;">
  `;
